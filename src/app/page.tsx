...
export default function Home() {
  const [selectedExchanges, setSelectedExchanges] = useState<string[]>(['Hyperliquid', 'Binance', 'Bybit', 'Gate']);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <div className="relative max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="flex items-center gap-2 mb-4 overflow-x-auto pb-2 scrollbar-hide">
              {['Hyperliquid', 'Binance', 'Bybit', 'Gate'].map(exchange => (
                <button
                  key={exchange}
                  onClick={() => {
        ...
        <footer className="mt-8 text-center text-xs text-slate-600">
          Auto-refreshes every 30s · Powered by Binance, Hyperliquid, Bybit & Gate APIs
        </footer>
      </div>
    </div>
  );
